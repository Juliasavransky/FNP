...
class BreastPumps extends Component {
    render() {
        ...
        const BreastPumpsAds = ads.filter(ad => ad.SubCategoryId === BreastPumpsPage)

        const BreastPumpsAdsUi = BreastPumpsAds.map(ad => <Col lg={3} md={4} sm={6}><AdCard ad={ad} /></Col>)
